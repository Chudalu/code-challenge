//To test, you can copy function and paste on web dev console and run. 
//then paste test example sockMerchant(9, [10, 20, 20, 10, 10, 30, 50, 10, 20])
function sockMerchant(count=null, socks) {
